...
from policy_nav import PolicyMotionController
...
if __name__ == "__main__":
    ...
    command = ['python3', './policy_nav.py', '--ipos', ipos, '--gpos', gpos, '--policy_file', policy_file]
    my_nav_process = subprocess.Popen(command)
    # agent = PolicyMotionController(GOAL_POSITION, INIT_POSITION, policy_file, gazebo_sim)
